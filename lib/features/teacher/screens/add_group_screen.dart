    ...
    return Scaffold(
      ...
      body: Column(
        children: [
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: _isLoading ? const CircularProgressIndicator(color: Colors.white) : const Text('حفظ', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                      ),
                    ),
                  ],
                ),
          ...
          const Padding(padding: EdgeInsets.symmetric(horizontal: 20.0), child: Divider(thickness: 1.5)),
          const Padding(
            padding: EdgeInsets.symmetric(horizontal: 20.0, vertical: 8.0),
            child: Align(alignment: Alignment.centerRight, child: Text('المجموعات الحالية', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1B3B5A)))),
          ),
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data!.docs.isEmpty) return const Center(child: Text('لا توجد مجموعات حتى الآن', style: TextStyle(color: Colors.grey, fontSize: 16)));
