    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          title: const Text('لوحة تحكم المدرس', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
          centerTitle: true,
          actions: [
            IconButton(
            ...
            children: [
              isLoadingName
                  ...
                  : Text(
                      ...
                      style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Color(0xFF1B3B5A)),
                    ),
              const SizedBox(height: 8),
              const Text('اختر القسم الذي تريد إدارته', style: TextStyle(fontSize: 16, color: Colors.grey)),
                ...
                child: GridView.count(
                  ...
                  children: [
                    _buildDashboardCard(
                      ...
                      badgeStream: _teacherService.getPendingRequests(), 
                      onTap: () {
                    ...
                    _buildDashboardCard(
                      ...
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => const TeacherAssignmentsScreen()));
                      },
                    ),
                    _buildDashboardCard(
                      context,
                      ...
                      icon: Icons.grading,
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => const ExamGradesScreen()));
                      },
                    ),
                    _buildDashboardCard(
                      context,
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: const TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Color(0xFF1B3B5A)),
            ),
          ],
        ),
      ),
