...
class _ExamGradesScreenState extends State<ExamGradesScreen> {
  ...
  Future<void> _fetchStudents() async {
    ...
    Map<String, String> existingGrades = await _teacherService.getExamGradesForDate(_selectedStage!, _selectedGroup!, _examNameController.text.trim(), _selectedDate);
    ...
    setState(() {
      ...
      for (var student in _students) {
        ...
        _gradesData[id] = existingGrades[id] ?? ""; 
      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('رصد درجات الامتحانات')),
      body: Form(
        key: _formKey,
        child: Column(
          children: [
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('تاريخ الامتحان: ${_selectedDate.year}-${_selectedDate.month}-${_selectedDate.day}', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF1B3B5A))),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      width: 80,
                                      child: TextFormField(
                                        initialValue: _gradesData[studentId] ?? "",
                                        keyboardType: TextInputType.number,
                                        ...
                                        onChanged: (value) => _gradesData[studentId] = value,
                                      ),
                                    ),
                                  ],
                                ),
              ...
              Container(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: _isSaving ? null : () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        String result = await _teacherService.saveExamGrades(
                          ...
                          maxGrade: _maxGradeController.text.trim(),
                          date: _selectedDate,
                    ...
                    child: _isSaving ? const CircularProgressIndicator(color: Colors.white) : const Text('حفظ درجات الامتحان', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  ),
                ),
              ),
          ],
