...
class StudentReportScreen extends StatefulWidget {
  ...
  final int year;   // 👈 استلام السنة
  final int month;  // 👈 استلام الشهر
...
class _StudentReportScreenState extends State<StudentReportScreen> {
  ...
  Future<void> _fetchReportData() async {
    ...
    // 👈 فلترة التقرير لعرض بيانات الشهر والسنة المحددين فقط
        ...
        body: _isLoading
            ...
            : SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'تقرير شهر ${widget.month} لسنة ${widget.year}:', // 👈 توضيح الشهر في العنوان
