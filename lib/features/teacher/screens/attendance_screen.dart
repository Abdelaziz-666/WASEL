...
class _AttendanceScreenState extends State<AttendanceScreen> {
  ...
  Future<void> _fetchStudents() async {
    ...
    Map<String, bool> existingRecords = await _teacherService.getAttendanceForDate(_selectedStage!, _selectedGroup!, _selectedDate);
  ...
  Future<void> _pickDate(BuildContext context) async {
    ...
    if (picked != null && picked != _selectedDate) {
      ...
      if (_selectedStage != null && _selectedGroup != null) _fetchStudents();
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('حضور الحصة')),
      body: Column(
        children: [
          Container(
            color: Colors.white,
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text('تاريخ الحصة: ${_selectedDate.year}-${_selectedDate.month}-${_selectedDate.day}', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF1B3B5A))),
                  ...
                  StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return DropdownButtonFormField<String>(
                        ...
                        items: groups.map((group) => DropdownMenuItem(value: group['groupName'].toString(), child: Text(group['groupName']))).toList(),
                        onChanged: (val) {
          ...
          Expanded(
            child: _isLoadingStudents
                ...
                : _students.isEmpty && _selectedGroup != null
                    ? const Center(child: Text('لا يوجد طلاب معتمدين في هذه المجموعة', style: TextStyle(fontSize: 16, color: Colors.grey)))
                    : ListView.builder(
                        padding: const EdgeInsets.all(16),
                          ...
                          return Card(
                            ...
                            child: CheckboxListTile(
                              ...
                              onChanged: (bool? value) {
                                setState(() => _attendanceData[studentId] = value ?? false);
                              },
                            ),
                          );
                        },
            ...
            Container(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: _isSaving ? const CircularProgressIndicator(color: Colors.white) : const Text('حفظ سجل الحضور', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                ),
              ),
            ),
        ],
